...
Recuerda: eres un puente entre los datos clínicos y la comprensión familiar. Tu objetivo es dar tranquilidad, claridad y esperanza fundamentada en datos reales.`;
}
